  ...
  return (
    <div className="max-w-5xl mx-auto">
      <DocHeader
        ...
        description="Découvrez notre processus de livraison en 5 étapes qui garantit des résultats de qualité et une expérience transparente."
          ...
          <div className="space-y-4 mt-6">
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside text-sm text-muted-foreground pl-2 space-y-1">
                <li>Réponses complètes au questionnaire de brief</li>
                <li>Fourniture des ressources et éléments demandés</li>
                <li>Disponibilité pour une réunion si nécessaire</li>
                <li>Partage de références ou exemples que vous appréciez</li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                À la fin de cette phase, nous aurons une compréhension claire de vos besoins et objectifs, et vous recevrez une confirmation du brief validé qui servira de feuille de route pour le projet.
              </p>
            </div>
          </div>
        </div>
