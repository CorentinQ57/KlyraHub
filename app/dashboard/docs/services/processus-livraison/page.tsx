...
export default function ProcessusLivraisonPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-10">
          ...
          <section id="best-practices" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              ...
              <div className="border rounded-lg p-5 space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Assurez-vous que toutes les parties prenantes sont impliquées dès le début du projet pour éviter des changements majeurs de direction en cours de route.
                </p>
              </div>

              <div className="border rounded-lg p-5 space-y-3">
                <h3 className="font-semibold">Respectez le scope initial</h3>
                <p className="text-sm text-muted-foreground">
                  Les modifications majeures hors du périmètre initial peuvent impacter les délais et le coût. Discutez avec votre chef de projet pour toute évolution significative.
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="border-t pt-6 mt-8">
            <div className="flex justify-between items-center">
              <Button variant="outline" asChild>
                <Link href="/dashboard/docs/services/catalogue">
                  ← Catalogue de services
                </Link>
              </Button>
              <Button asChild>
                <Link href="/dashboard/docs/services/livrables">
      ...
      {/* Barre latérale */}
      <div className="w-full lg:w-72 lg:flex-none space-y-6">
        <TableOfContents items={tocItems} />
        <LinkCard title="Pages associées" links={relatedLinks} />
      </div>
    </div>
  );
} 