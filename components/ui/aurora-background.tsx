...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "relative flex flex-col h-full min-h-[100vh] items-center justify-center bg-gradient-to-b from-klyra-bg to-white dark:from-zinc-900 dark:to-zinc-950 text-slate-950 transition-bg",
          className
        )}
        {...props}
      >
